"""NumPy implementation for the MyoFullBody musculoskeletal model."""
...
class MyoFullBody(BodyModel):
    ...
    def __init__(self, model_path: Path | str | None = None) -> None:
        ...
        self.qpos_axes = data["qpos_joint_axes"]
        self.qpos_anchors = data["qpos_joint_anchors"]
        self.qpos_limits = data["qpos_joint_limits"]
        self.hinge_mask = data["hinge_mask"]
        self.slide_mask = data["slide_mask"]
