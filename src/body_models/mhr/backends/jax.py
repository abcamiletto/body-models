...
def forward_vertices(
    ...
    *,
    ...
    joint_translations: Float[jax.Array, "*batch J 3"],
    joint_rotations: Float[jax.Array, "*batch J 3 3"],
    joint_scales: Float[jax.Array, "*batch J 1"],
    joint_params: Float[jax.Array, "*batch J 7"],
):
