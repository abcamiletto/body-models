...
from body_models.skeletons.skel.backends.core import forward_skeleton as _forward_skeleton
from body_models.skeletons.skel.backends.core import forward_vertices as _forward_vertices
from body_models.skeletons.skel.backends.core import prepare_identity as _prepare_identity
from body_models.skeletons.skel.backends.core import prepare_pose as _prepare_pose
from body_models.skeletons.skel.io import SkelWeights
...
def forward_vertices(
    ...
    skinning_transforms: Float[jax.Array, "*batch 24 4 4"],
...
def forward_skeleton(
    weights: SkelWeights,
    skeleton_transforms: Float[jax.Array, "*batch 24 4 4"],
    global_rotation: Float[jax.Array, "*batch 3"] | None = None,
    global_translation: Float[jax.Array, "*batch 3"] | None = None,
