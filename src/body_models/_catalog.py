...
MODEL_SPECS: Mapping[str, ModelSpec] = MappingProxyType(
    {
        ...
        "mannequin": _model("body_models.smpl_humanoid", "SmplMannequin"),
        "mannequin-lod1": _model(
            "body_models.smpl_humanoid",
            "SmplMannequin",
            variant="mannequin_lod1",
        ),
        "mannequin-lod2": _model(
            "body_models.smpl_humanoid",
            "SmplMannequin",
            variant="mannequin_lod2",
        ),
        ...
        "smplx-mannequin": _model("body_models.smpl_humanoid", "SmplxMannequin"),
...
ASSET_SPECS: Mapping[str, AssetSpec] = MappingProxyType(
    {
        ...
        **_assets(
            ...
            "smpl-humanoid-mannequin",
            "smpl-humanoid-mannequin-lod1",
            "smpl-humanoid-mannequin-lod2",
