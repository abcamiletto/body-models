...
from body_models.common import at_set
...
def hidden_activations(
    ...
    *,
    ...
    features = relative[..., :, :, :2]
    features = at_set(features, (..., slice(None), 0, 0), features[..., :, 0, 0] - 1, xp=xp)
    features = at_set(features, (..., slice(None), 1, 1), features[..., :, 1, 1] - 1, xp=xp)
