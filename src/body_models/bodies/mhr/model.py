...
class MhrIdentityParameters(NamedTuple):
    shape: Float[Array, "*batch 45"]
    expression: Float[Array, "*batch 72"]


class MhrParameters(NamedTuple):
    identity: MhrIdentityParameters | core.MhrIdentity
...
class MHRModel(SkinnedModel):
    ...
    def forward_vertices(
        ...
        *,
        ...
        pose = self.prepare_pose(parameters)
    ...
    def forward_skeleton(
        ...
        *,
        ...
        xp = self._runtime.xp
        pose = pack_pose(xp, parameters.body_pose, parameters.head_pose, parameters.hand_pose)
    ...
    def prepare_identity(
        self,
        parameters: MhrIdentityParameters,
    ) -> core.MhrIdentity:
    ...
    def get_rest_pose(
        ...
        return MhrParameters(
            identity=MhrIdentityParameters(
    ...
    def get_tpose(
        ...
        **kwargs: Any,
        ...
        body_pose, head_pose, _ = unpack_pose(self._runtime.xp, pose)
    ...
    def prepare(self, parameters: MhrParameters) -> MhrParameters:
        return parameters._replace(identity=self._identity(parameters))

    def _identity(self, parameters: MhrParameters) -> core.MhrIdentity:
        identity = parameters.identity
        if not isinstance(identity, MhrIdentityParameters):
            return identity
        ...
        return self.prepare_identity(MhrIdentityParameters(shape, expression))


__all__ = ["MHRModel", "MhrIdentityParameters", "MhrParameters"]
