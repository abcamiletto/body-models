...
from body_models.bodies.soma.identities import numpy as identity_sources
...
class SOMA(SkinnedModel):
    ...
    @property
    def _skinning_weights(self) -> Float[np.ndarray, "V J"]:
        return core.skinning_weights(self.weights).toarray()
