...
ASSET_SPECS: Mapping[str, AssetSpec] = MappingProxyType(
    {
        **_assets("body_models.smpl.io", "smpl-male", "smpl-female", "smpl-neutral"),
        **_assets("body_models.smplx.io", "smplx-male", "smplx-female", "smplx-neutral"),
        **_assets("body_models.smplh.io", "smplh-male", "smplh-female", "smplh-neutral"),
        **_assets(
            "body_models.smpl_humanoid.io",
            "smpl-humanoid-humenv",
            "smpl-humanoid-phc",
            "smpl-humanoid-smplsim",
        ),
        **_assets("body_models.mano.io", "mano-right", "mano-left"),
        **_assets("body_models.skel.io", "skel-male", "skel-female"),
        **_assets("body_models.anny.io", "anny"),
        **_assets("body_models.mhr.io", "mhr"),
        **_assets("body_models.flame.io", "flame"),
        **_assets("body_models.brainco.io", "brainco"),
        **_assets("body_models.g1.io", "g1"),
        **_assets("body_models.soma.io", "soma"),
        **_assets("body_models.garment_measurements.io", "garment-measurements"),
        **_assets("body_models.myofullbody.io", "myofullbody"),
    }
)
...
DOWNLOAD_SPECS: Mapping[str, DownloadSpec] = MappingProxyType(
    {
        ...
        "smpl-humanoid": DownloadSpec("body_models.smpl_humanoid.io", "download_assets"),
        "skel": DownloadSpec(
            "body_models.download",
        ...
        "anny": DownloadSpec("body_models.anny.io", "download_model", output_key="anny"),
        "brainco": DownloadSpec("body_models.brainco.io", "download_model", output_key="brainco"),
        "mhr": DownloadSpec("body_models.mhr.io", "download_model", output_key="mhr"),
        "g1": DownloadSpec("body_models.g1.io", "download_model", output_key="g1"),
        "soma": DownloadSpec("body_models.soma.io", "download_model", output_key="soma"),
        "garment-measurements": DownloadSpec(
            "body_models.garment_measurements.io",
            "download_model",
            output_key="garment-measurements",
        ),
        "myofullbody": DownloadSpec(
            "body_models.myofullbody.io",
            "download_model",
