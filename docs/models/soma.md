...
For differentiable Torch or JAX optimization, pass `bind_pose_grad=False` to compute the identity-dependent bind pose while stopping gradients through that skeleton fit.
